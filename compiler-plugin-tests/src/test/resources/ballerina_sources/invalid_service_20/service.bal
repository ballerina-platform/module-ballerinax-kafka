...
service kafka:Service on kafkaListener {
    remote function onConsumerRecord(kafka:Caller caller, readonly & kafka:Caller caller2, int & readonly data) {
    }
}

service kafka:Service on kafkaListener {
    remote function onConsumerRecord(int & readonly data, kafka:Caller caller) {
    }
}
